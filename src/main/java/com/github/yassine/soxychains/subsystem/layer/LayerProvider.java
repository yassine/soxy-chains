...
public interface LayerProvider<CONFIGURATION extends AbstractLayerConfiguration, NODE_CONFIGURATION extends LayerNodeConfiguration> {
  void configureNode(CreateContainerCmd containerCmd, NODE_CONFIGURATION node_configuration, CONFIGURATION layerConfiguration);
  boolean matches(Container container, NODE_CONFIGURATION node_configuration, CONFIGURATION layerConfiguration);
  DockerImage image();
}
